...
var quoteArr = ["Food is an important part of a balanced diet!", "I cook with wine. Sometimes I even add it to the food.", "Cooling is like love. It should be intered into with abandon, or not at all.", "Life is a combination of magic and pasta.", "Promises and pie-crust are made to be broken", "Cheese - milk's leap towards immortality.", "Rice is great if you're hungry and want 2,000 of something.", "It would be a sad waste of opportuity to eat badly.", "First we eat. Then we do everything else.", "A balanced diet is a cookie in each hand.", "Ask not what you can do for your country. Ask what's for lunch." ];
